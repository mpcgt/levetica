...
function Apps() {
  ...
  <br />
      ...
      <h3>• Synchronisation dans le cloud ☁️ : Synchronisez vos données (favoris, mots de passes, cookies, etc.) sur vos différents appareils et vers le cloud.</h3>
      ...
      <h3>• Extensible par plugins/extensions 🛠️ : Firefox peut être étendu avec des modules complémentaires, des plugins et des extensions.</h3>
  </div>
    </>
    )
  }
