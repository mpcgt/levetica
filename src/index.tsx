  ...
  return (
    ...
    <div className='center'>
      ...
      <h3 className='text'>Levetica + React = ❤️</h3>
        <p className='text'>
          <i>Levetica est actuellement en construction, ce site passe de Angular à React </i><img src={ang_react} height="85" width="160" alt="Angular vers React" /><img src={loading} height="24" width="24" alt='Loading' />
