    ...
    <>
      ...
      <div className="center">
        ...
        <div className="border">
          ...
          <p>
            <strong>
              <u>Annonces de Levetica : (14/06/2024)</u>
            </strong>
            <br />
            <br />
            Ce site web est actuellement en construction, ce site sera
            officiellement publiée en bêta le <b>1er juillet 2024 à 18h</b>
            <br />
            <br />
            ...
            <a href="https://levetica.vercel.app">code source</a> du site et
